...
\begin{figure}
  \centering
  \includegraphics[width=0.8\hsize]{figures/Nrvcomparison.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\hsize]{figures/sigRVhist.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\hsize]{figures/optnIRratio.png}
...
\begin{figure*}
  \centering
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_Teff_bkgd.png}%
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:optoff}{fig:optoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:opton}{fig:opton}{1}%
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_Teff_opt.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:niroff}{fig:niroff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:niron}{fig:niron}{1}%
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_Teff_nir.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%  
...
\begin{figure*}
  \centering
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_rp_bkgd.png}%
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:optoffr}{fig:optoffr}{0}%
  \end{ocg}%
  \begin{ocg}{fig:optonr}{fig:optonr}{1}%
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_rp_opt.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:niroffr}{fig:niroffr}{0}%
  \end{ocg}%
  \begin{ocg}{fig:nironr}{fig:nironr}{1}%
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_rp_nir.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
  \caption{\small \emph{Upper panel}: the cumulative median observing time to measure the $3\sigma$ RV masses of
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_50random4_bkgd.png}%
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:optoff50}{fig:optoff50}{0}%
  \end{ocg}%
  \begin{ocg}{fig:opton50}{fig:opton50}{1}%
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_50random4_opt.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:niroff50}{fig:niroff50}{0}%
  \end{ocg}%
  \begin{ocg}{fig:niron50}{fig:niron50}{1}%
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_50random4_nir.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\hsize]{figures/identify50_bkgd.png}%
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:bestoff}{fig:bestoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:beston}{fig:beston}{1}%
  \includegraphics[width=0.8\hsize]{figures/identify50_best.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:regionoff}{fig:regionoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:regionon}{fig:regionon}{1}%
  \includegraphics[width=0.8\hsize]{figures/identify50_region.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_radvalley_bkgd.png}%
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:optoffMR}{fig:optoffMR}{0}%
  \end{ocg}%
  \begin{ocg}{fig:optonMR}{fig:optonMR}{1}%
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_radvalley_opt.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:niroffMR}{fig:niroffMR}{0}%
  \end{ocg}%
  \begin{ocg}{fig:nironMR}{fig:nironMR}{1}%
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_radvalley_nir.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_HZ_bkgd.png}%
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:optoffHZ}{fig:optoffHZ}{0}%
  \end{ocg}%
  \begin{ocg}{fig:optonHZ}{fig:optonHZ}{1}%
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_HZ_opt.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:niroffHZ}{fig:niroffHZ}{0}%
  \end{ocg}%
  \begin{ocg}{fig:nironHZ}{fig:nironHZ}{1}%
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_HZ_nir.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_transmission_bkgd.png}%
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:optoffjwst}{fig:optoffjwst}{0}%
  \end{ocg}%
  \begin{ocg}{fig:optonjwst}{fig:optonjwst}{1}%
   \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_transmission_opt.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
  \begin{ocg}{fig:niroffjwst}{fig:niroffjwst}{0}%
  \end{ocg}%
  \begin{ocg}{fig:nironjwst}{fig:nironjwst}{1}%
   \includegraphics[width=0.8\hsize]{figures/cumulativetobsGP_transmission_nir.png}%
  \end{ocg}
  \hspace{-0.8\hsize}%
