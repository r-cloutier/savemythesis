...
\begin{figure*}
  ...
  \end{ocg}
  \hspace{-0.8\hsize}%
  \caption{\small Scatter plots and histograms depicting the distribution of SPIRou input catalog
...
\begin{figure}
  ...
  \end{ocg}
  \hspace{-0.8\hsize}%
  \caption{\small Cumulative distribution functions of the 
...
\begin{figure}
  ...
  \end{ocg}
  \hspace{-0.6\hsize}%
  \caption{\small The RV activity rms as a function of stellar rotation period for stars in the simulated SLS-PS compared
...
\begin{figure}
  ...
  \end{ocg}
  \hspace{-0.8\hsize}%
  \caption{\small Lomb-Scargle periodogram of an example window function from the simulated SLS-PS.
...
\begin{figure}
  ...
  \caption{\small The median RV measurement uncertainty in each simulated RV time-series $\sigma_{\text{RV}}$
...
\begin{figure}
  ...
  \end{ocg}
  \hspace{-0.6\hsize}%
  \caption{\small 2D histogram depicting the masses and radii of the sampled
...
\begin{figure}
  ...
  \end{ocg}
  \hspace{-0.8\hsize}%
  \caption{\small \emph{Top}: histograms of the injected small planet population in the simulated SLS-PS
...
\begin{figure}
  ...
  \caption{\small The probability density function of planet multiplicities in the simulated SLS-PS.
...
\begin{figure*}
  ...
  \end{ocg}
  \hspace{-\hsize}%
  \caption{\small Examples of our GP formalism used to mitigate RV activity and detect underlying planetary signals for two
...
\begin{figure}
  ...
  \end{ocg}
  \hspace{-0.6\hsize}%
  \caption{\small Comparison of the rms of the \emph{injected} RV activity to the rms of the \emph{residual} RV activity following
...
\begin{figure}
  ...
  \end{ocg}
  \hspace{-0.8\hsize}%
  \caption{\small \emph{Top to bottom}: Lomb-Scargle periodograms of the full width at half maximum (FWHM)
...
\begin{figure}
  ...
  \end{ocg}
  \hspace{-0.6\hsize}%
  \caption{\small The number of planets detected as a function of \msini{} after each of the three steps in
...
\begin{figure*}
  ...
  \end{ocg}
  \hspace{-\hsize}%
  \caption{\small Binned maps of the detection sensitivity of the full SPIRou input catalog derived using our
...
\begin{figure*}
  ...
  \end{ocg}
  \hspace{-\hsize}%
  \caption{\small Coarsely binned maps of the predicted planet yield from 
...
\begin{figure*}
  ...
  \caption{\small A random subset of the simulated SPIRou planets representative of the underlying planet
...
\begin{figure}
  ...
  \end{ocg}
  \hspace{-0.6\hsize}%
  \caption{\small \emph{Top}: the detection sensitivity as a function of minimum planet mass
...
\begin{figure*}
  ...
  \end{ocg}
  \hspace{-\hsize}%
  \caption{\small Coarsely binned maps of the RV planet frequency derived from the  
...
\begin{figure}
  ...
  \caption{\small The probability density function of the RV value of $\eta_{\oplus}$ derived from
...
\begin{figure*}
  ...
  \end{ocg}
  \hspace{-0.8\hsize}%
  \caption{\small The same random subset of the simulated SPIRou planets from Fig.~\ref{BSfig:spiroudet}
