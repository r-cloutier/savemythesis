...
\begin{figure*}
  \centering
  %\000raphics[width=\hsize]{figures/stellarpop_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:staroff}{fig:staroff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:staron}{fig:staron}{1}%
    %\000raphics[width=\hsize]{figures/stellarpop_stars.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/rmsactivityProt_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:curveoff}{fig:curveoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:curveon}{fig:curveon}{1}%
    %\000raphics[width=\hsize]{figures/rmsactivityProt_means.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:Hoff}{fig:Hoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:Hon}{fig:Hon}{1}%
    %\000raphics[width=\hsize]{figures/rmsactivityProt_HARPS.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/WF_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:Poff}{fig:Poff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:Pon}{fig:Pon}{1}%
    %\000raphics[width=\hsize]{figures/WF_Ps.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:FAPoff}{fig:FAPoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:FAPon}{fig:FAPon}{1}%
    %\000raphics[width=\hsize]{figures/WF_faps.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/sigmaRV.png}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/MRscatter_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:curveoff}{fig:curveoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:curveon}{fig:curveon}{1}%
    %\000raphics[width=\hsize]{figures/MRscatter_curves.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:eboff}{fig:eboff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:ebon}{fig:ebon}{1}%
    %\000raphics[width=\hsize]{figures/MRscatter_scatter.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/mpoccurrence_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:0off}{fig:0off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:0on}{fig:0on}{1}%
    %\000raphics[width=\hsize]{figures/mpoccurrence_0.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:1off}{fig:1off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:1on}{fig:1on}{1}%
    %\000raphics[width=\hsize]{figures/mpoccurrence_1.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:2off}{fig:2off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:2on}{fig:2on}{1}%
    %\000raphics[width=\hsize]{figures/mpoccurrence_2.png}%
  \end{ocg}
  \hspace{-\hsize}%
    \begin{ocg}{fig:3off}{fig:3off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:3on}{fig:3on}{1}%
    %\000raphics[width=\hsize]{figures/mpoccurrence_3.png}%
  \end{ocg}
  \hspace{-\hsize}%
    \begin{ocg}{fig:4off}{fig:4off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:4on}{fig:4on}{1}%
    %\000raphics[width=\hsize]{figures/mpoccurrence_4.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/multhist.png}%
...
\input{chapters/BS_fwhmpriortable}


\begin{figure*}
  \centering
  %\000raphics[width=\hsize]{figures/GPexample_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:GPoff}{fig:GPoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:GPon}{fig:GPon}{1}%
    %\000raphics[width=\hsize]{figures/GPexample_GP.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/compareGPres_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:detoff}{fig:detoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:deton}{fig:deton}{1}%
   %\000raphics[width=\hsize]{figures/compareGPres_det.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:nondetoff}{fig:nondetoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:nondeton}{fig:nondeton}{1}%
   %\000raphics[width=\hsize]{figures/compareGPres_nondet.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/periodograms_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:Poff}{fig:Poff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:Pon}{fig:Pon}{1}%
    %\000raphics[width=\hsize]{figures/periodograms_Ps.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:FAPoff}{fig:FAPoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:FAPon}{fig:FAPon}{1}%
    %\000raphics[width=\hsize]{figures/periodograms_FAP.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/detectedpopulations_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:1off}{fig:1off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:1on}{fig:1on}{1}%
    %\000raphics[width=\hsize]{figures/detectedpopulations_1.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:2off}{fig:2off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:2on}{fig:2on}{1}%
    %\000raphics[width=\hsize]{figures/detectedpopulations_2.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:3off}{fig:3off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:3on}{fig:3on}{1}%
    %\000raphics[width=\hsize]{figures/detectedpopulations_3.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure*}
  \centering
  %\000raphics[width=0.5\hsize]{figures/sensPMpsini_bkgd_pickles_optimized100_final.png}%
  %\000raphics[width=0.5\hsize]{figures/sensFMpsini_bkgd_pickles_optimized100_final.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:shadeoff}{fig:shadeoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:shadeon}{fig:shadeon}{1}%
    %\000raphics[width=0.5\hsize]{figures/sensPMpsini_shade_pickles_optimized100_final.png}%
    %\000raphics[width=0.5\hsize]{figures/sensFMpsini_shade_pickles_optimized100_final.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:Koff}{fig:Koff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:Kon}{fig:Kon}{1}%
    %\000raphics[width=0.5\hsize]{figures/sensPMpsini_Kline_pickles_optimized100_final.png}%
    %\000raphics[width=0.5\hsize]{figures/sensFMpsini_Kline_pickles_optimized100_final.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:HZoff}{fig:HZoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:HZon}{fig:HZon}{1}%
    %\000raphics[width=0.5\hsize]{figures/yieldPMpsini_HZ.png}%
    %\000raphics[width=0.5\hsize]{figures/yieldFMpsini_HZ.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure*}
  \centering
  %\000raphics[width=0.5\hsize]{figures/yieldPMpsini_bkgd.png}%
  %\000raphics[width=0.5\hsize]{figures/yieldFMpsini_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:shadeoff}{fig:shadeoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:shadeon}{fig:shadeon}{1}%
    %\000raphics[width=0.5\hsize]{figures/yieldPMpsini_text.png}%
    %\000raphics[width=0.5\hsize]{figures/yieldFMpsini_text.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:HZoff}{fig:HZoff}{0}%
  \end{ocg}%
...
\begin{figure*}
  \centering
  %\000raphics[width=\hsize]{figures/SPIRoudet_Fmpsini.png}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/2occ_opt_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:1off}{fig:1off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:1on}{fig:1on}{1}%
    %\000raphics[width=\hsize]{figures/2occ_opt_1.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:2off}{fig:2off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:2on}{fig:2on}{1}%
    %\000raphics[width=\hsize]{figures/2occ_opt_2.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure*}
  \centering
  %\000raphics[width=0.5\hsize]{figures/occurrencePMpsini_bkgd.png}%
  %\000raphics[width=0.5\hsize]{figures/occurrenceFMpsini_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:postoff}{fig:postoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:poston}{fig:poston}{1}%
    %\000raphics[width=0.5\hsize]{figures/occurrencePMpsini_post.png}%
    %\000raphics[width=0.5\hsize]{figures/occurrenceFMpsini_post.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:hzoff}{fig:hzoff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:hzon}{fig:hzon}{1}%
    %\000raphics[width=0.5\hsize]{figures/occurrencePMpsini_HZ.png}%
    %\000raphics[width=0.5\hsize]{figures/occurrenceFMpsini_HZ.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\begin{figure}
  \centering
  %\000raphics[width=\hsize]{figures/etaEarth.png}
...
\begin{figure*}
  \centering
  %\000raphics[width=\hsize]{figures/SPIRoudet_contrast_bkgd.png}%
  \hspace{-\hsize}%
  \begin{ocg}{fig:Poff}{fig:Poff}{0}%
  \end{ocg}%
  \begin{ocg}{fig:Pon}{fig:Pon}{1}%
   %\000raphics[width=\hsize]{figures/SPIRoudet_contrast_planets.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:c1off}{fig:c1off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:c1on}{fig:c21on}{1}%
   %\000raphics[width=\hsize]{figures/SPIRoudet_contrast_curve1.png}%
  \end{ocg}
  \hspace{-\hsize}%
  \begin{ocg}{fig:c2off}{fig:c2off}{0}%
  \end{ocg}%
  \begin{ocg}{fig:c2on}{fig:c2on}{1}%
   %\000raphics[width=\hsize]{figures/SPIRoudet_contrast_curve2.png}%
  \end{ocg}
  \hspace{-\hsize}%
...
\input{chapters/BS_summarytable}
