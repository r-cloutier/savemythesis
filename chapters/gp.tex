...
\begin{figure}
  \centering
  %\includegraphics[width=0.8\hsize]{figures/linearrep_v1.png}
  \caption[Linear representation of Gaussian random varaibles in two dimensions.]
          {Samples from the two-dimensional Gaussian distribution depicted in the
            conventional way (left panel) and in the new linear representation (right
            panel). The $GAA$ and $SV$\%
            variables are scaled to a common unit and offset for clarity.}
  \label{fig:linrep}
\end{figure}
