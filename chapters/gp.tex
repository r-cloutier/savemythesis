...
to model the temporally correlated phyiscal process of stellar RV activity. The forecoming
...
signal takes the form of a cirular keplerian with $P=22$ days and $K=2$ \mps{.} The stellar
...
of 1 \mps{.} A notable exception to the innaccuracy of the GP activity model is in its failure to
capture the pile up of injected RVs at 0 \mps{} corresponding to when the singla simulated starspot is
