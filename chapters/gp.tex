...
\begin{figure}
  ...
  \caption[Synthetic RV time series used to demonstrate the effectiveness of GP activity modelling.]
          {\emph{Top}: a synthetic RV time series with injected stellar activity from a \texttt{SOAP 2.0} physical
            model (\prot{} $=30$ days; \emph{red curve}), a keplerian planetary signal ($P=22$ days; \emph{blue curve}), and noise.
...
compared to the injected semi-amplitude of 2 \mps{.} However it is clearly consistent within $1\sigma$.
