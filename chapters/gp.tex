...
a parameterization of the data covariance. A number of covariance kernels have been proposed
for the treatment of stellar RV activity including the squared exponential covariance kernel
of the form

\begin{equation}
  k(t_i,t_j) = \exp{\left( -\frac{(t_i-t_j)^2}{2\lambda^2} \right)}.
\end{equation}

\noindent The squared expoential 


Fortuntately, stellar activity on M dwarfs 
...
although the periodicity of to be correlat

Thus we have a physical justification for adopting a QP covariance kernel.
