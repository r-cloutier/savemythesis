\chapter{Introduction: radial velocity studies of planets around small stars}
...
around M dwarfs \citep{kasting93,kopparapu13}, where the probablilty of hosting potentially
...
and cannot be significantly improved by post processing. These challenges associcated with building
...
counting errors can be minimized. Fig.~\ref{fig:sigrv} demonstrates these dependancies over the spectral
...
\begin{figure}
  ...
  \caption[Doppler information content over spectral band passes and stellar properties.]
    ...
    representative of true $\sigma_{\gamma}$ values particualy in the near-IR bands
...
of telluric contamination of the stellar spectrum by spectral features origining from Earth's
...
Such obervables include spectroscopic activity indicators such as the $H\alpha$ and
\caii{} H+K indices which are magnetically sensitive features origining from the hot stellar
chromosphere, line deformation diagnostics (e.g. CCF shape parameters; \citealt{boisse11},
line-by-line analyzes \citealt{dumusque18}), plus Doppler imaging of the stellar surface
