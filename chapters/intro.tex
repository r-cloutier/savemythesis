...
distribution of spectral types throughout the galaxy while outnumbering Sun-like stars
...
are more easily detectable in radial velocity compared to Sun-like stars due to the
their reduced masses (see Sect.~\ref{sect:K}). Furthermore, the habitable zone
around M dwarfs \citep{kasting93,kopparapu13}, where the probability of hosting potentially
habitable planets is maximized due to the planetary equilibrium temperatures there,
...
deters the prospect of finding signs of life like us on M dwarf planets, it also inhibits
...
potential deviates significantly from radial symmetry because of an gravitational anomaly from a
...
than purely Gaussian even in the absence of surface inhomogeneities \citep{cegla16}.
...
can be detected at high signal-to-noise ratio
and that their origin dominates the astrophysical RV budget (as opposed to
...
for telluric contamination, and astrophysical noise. Here we review the radial velocity error budget
...
with a high metallicity are favourable as they exhibit more molecular and metal features over which
...
eliminates such a large fraction of the available RV information that it negates the benefits
of developing near-IR RV spectrographs at all.
Instead, near-IR RVs are relying on more sophisticated methods of telluric spectrum extraction and
removal including atmospheric transmission models \citep[e.g.][]{vacca03,bertaux14}
...
\begin{figure}
  ...
  \caption[Atmospheric transmission from 0.3-5 $\mu$m.]
          {A model of telluric absorption from 0.3-5 \micron{} calculated using the LBLRTM radiative transfer
            ...
            short observing windows at the $YJHK_{\text{S}}LL'$ bands. Telluric absorption in the optical is
...
can lead to temporally correlated RV signals which can be collectively
...
\citep{hebrard16}. Some observables as they pertain to specific studies presented herein will
be discussed in further detail as required. \\

Examples of sources of stellar activity are summarized below
while brief summaries are given in Table~\ref{table:activity}. \\
...
few \mps{} on timescales of a few to tens of minutes \citep{bedding01}. 
...
surface varies on a similar timescale. However, supergranules may also persist over longer timescales
albeit with smaller RV contributions \citep[$\lesssim 1$ \mps{;}][]{rincon17}
...
\emph{Active Regions}:
like the Sun, the photospheres of active M dwarfs are often littered with active regions such
as dark star spots and/or hot faculae or plages in the chromosphere. Indeed,
...
to one to a few stellar rotation timescales with those timescales being extended for later
...
stellar activity can on similar timescales. As seen in Fig.~\ref{fig:rotation},
the lifetimes can range from days to months and given that active region
lifetimes are primarily determined by their sizes as they
...
at the 10 cm s$^{-1}$ level which is sufficient to mask a Earth-like planet around a Sun-like star
...
redshift that varies on the timescale of variations in the star's magnetic field strength
\citep{cegla11}.
...
relation between the RVs and the contemporaneous \Rkh{} time series although residual jitter
