\chapter{The independent discovery of planet candidates around low mass stars and astrophysical false positives from the first two TESS sectors}
...
\begin{figure}
  \centering
  %\includegraphics[scale=.9]{stellar_corner.png}
  \caption{Distributions of TESS apparent magnitudes $T$, effective temperatures,
...
\begin{figure}
  \centering
  %\includegraphics{stellarradii.png}
...
\begin{figure*}
  \centering
  %\includegraphics[scale=.96]{GPdetrend_235037759.png}
  %\includegraphics[scale=.96]{GPdetrend_262530407.png}
  \caption{Two demonstrations of the \pipeline{} initial de-trending stage for TIC 235037759 and 262530407.
...
\begin{figure}
  \centering
  %\includegraphics[scale=.92]{linearsearch_234994474.png}
...
\begin{figure*}
  \centering
  %\includegraphics[scale=1]{periodicsearch_234994474.png}
  \caption{The results of the periodic search for repeating transit-like events in the
...
\begin{figure}
  \centering
  %\includegraphics[scale=.92]{flareLC_25200252.png}
...
\begin{figure*}
  \centering
  %\includegraphics[scale=.88]{planetcandidatesummary_1_234994474.png}
...
\begin{figure}
  \centering
  %\includegraphics{wtfLCs.png}
  \caption{The raw (i.e. pre-de-trended)
...
\begin{figure*}
  \centering
  %\includegraphics{GAIAFPs.png}
  \caption{Star maps containing sources from the GAIA DR2 in the vicinity of each TIC identified
...
\begin{figure}
  \centering
  %\includegraphics{TIC300_LC.png}
  \caption{The de-trended light curves of TICs 100103200 (top) and 100103201 (bottom).
...
\begin{figure*}
  \centering
  %\includegraphics[scale=1]{transitLC_PCs.png}
  \caption{Phase-folded transit light curves for our set of 16 planet candidates. The temporal binning and axes
...
\begin{figure*}
  \centering
  %\includegraphics[scale=1]{planetsample.png}
...
\begin{figure*}
  \centering
  %\includegraphics[scale=1]{planetsample_star.png}
  \caption{The planetary radii of our 16 \pipeline{} candidates as functions of their host stellar
...
%\subsubsection{New PCs detected by \pipeline{} in existing TOI systems}
%\emph{TIC 415969908} TOI-233.01 has an orbital period of 11.7 days. This signal is recovered
%by \pipeline{} along with two additional signals at 7.2 and 15.8 days respectively. The TIC
%415969908 light curve is depicted in Fig.~\ref{fig:tic415969908} along with the transits times
%of each PC. Notably,
%the orbital phases of the new PCs overlap with themselves at $\sim 1381$ BJD-2,4570,000.
%This indicates that although one signal may be due a transiting planet, it is highly unlikely that 
%they both are. The maximum likelihood scenario from the \pipeline{} fits is that the 15.8 day
%PC is favored over the PC at 7.2 days. Consequently, we discard the latter PC as a false
%positive at retain the former PC which should have two transits over the TESS sector 2
%baseline. However, it is clear that one of those transits overlaps with a transit of TOI-233.01
%at $\sim 1365.3$ BJD-2,457,000 such that the 15.8 day orbital period is likely misidentified.
%Knowning that the 15.8 day period is likely underestimated and the prominence of the transit-like
%event at $\sim 1381$ BJD-2,4570,000 that is not associated with TOI-233.01, we postulate that
%an second PC exists around TIC 415969908 and whose orbital period is greater than the 27.4 day
%baseline. This nature of this potential single transit event will require additional photometric
%and/or RV follow-up for a more accurate interpretation of its origin.

% refit transit with just the one event because at 15.8 days it mixes the wrong transit event
%P = 15.808056 +- 5e-3 days
%Rs^3/Ms =  2.2735132897e-5 +- 2.0655451970e-6 m3/kg
%a/Rs = 55.3434292 + 3.60904 - 10.62048
%_,_,samp_aRs = get_samples_from_percentiles(val, ehi, elo, Nsamp=1e3, add_p5_p95=True)
%estimate P from R3/M and a/R 

%\begin{figure}
%  \centering
%  %\includegraphics{TIC415969908_tmp.png}
%  \caption{The de-trended light curve of TIC 415969908 from TESS sector 2. The vertical
%    ticks indicate the transit times of the TOI-233.01 and the additional ST event identified by
%    \pipeline{} at 1381 BJD - 2,457,000. Both signals show low FPPs.}
%  \label{fig:415969908}
%\end{figure}
...
\begin{figure}
  \centering
  %\includegraphics{planetsample_followup.png}
...
%\input{chapters/orion_starphot}
%\input{chapters/orion_starparams}
%\input{chapters/orion_freeparamtable}
%\input{chapters/orion_priortable}
%\input{chapters/orion_vespatable}
%\input{chapters/orion_planetparams}
%\input{chapters/orion_planetfollowup}
